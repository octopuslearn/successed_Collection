...
// //这个替代版本的代码不需要
// //原子.h。相反，interrupts() 和 noInterrupts()
// //被使用。如果您的情况请使用此代码
// //平台不支持 ATOMIC_BLOCK。
...
// void readEncoder(){
//   // Read encoder B when ENCA rises//当ENCA上升时读取编码器B
//   int b = digitalRead(ENCB);
//   int increment = 0;
//   if(b>0){
//     // If B is high, increment forward//如果 B 为高，则向前递增
//     increment = 1;
//   }
//   else{
//     // Otherwise, increment backward//否则，向后递增
//     increment = -1;
//   }
