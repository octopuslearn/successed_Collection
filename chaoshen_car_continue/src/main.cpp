...
void loop()
{
  ...
  do
  {
    ...
    u8g2.setCursor((10 * 0), 10 * 2.5);
    u8g2.print(hd_value[1]);
    u8g2.setCursor((10 * 1), 10 * 2.5);
    u8g2.print(hd_value[2]);
    u8g2.setCursor((10 * 2), 10 * 2.5);
    u8g2.print(hd_value[3]);
    u8g2.setCursor((10 * 3), 10 * 2.5);
    u8g2.print(hd_value[4]);
    u8g2.setCursor((10 * 4), 10 * 2.5);
    u8g2.print(hd_value[5]);
    u8g2.setCursor((10 * 5), 10 * 2.5);
    u8g2.print(hd_value[6]);
    u8g2.setCursor((10 * 6), 10 * 2.5);
    u8g2.print(hd_value[7]);
    u8g2.setCursor((10 * 7), 10 * 2.5);
    u8g2.print(hd_value[8]);
